...
import { useRegisterEmailVerify } from "@/hooks/valuer/auth/useRegisterEmailVerify";
...
const FormEmailVerify: FC<Props> = ({ email }) => {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    // Push to [Register page 2: register]
    if (isCorrect) push(`/valuer/register?email=${encodeURIComponent(email)}`);
  };
