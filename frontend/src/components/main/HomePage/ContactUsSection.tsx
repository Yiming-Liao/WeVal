import Buildings from "@/components/svg/main/home-page/ContactUsSection/Buildings";
import Image from "next/image";
import Link from "next/link";

const ContactUsSection = () => {
  return (
    <section className="relative w-full h-[360px] flex justify-center items-center overflow-hidden">
      {/* Link */}
      ...
      {/* Background SVG */}
      <div className="absolute right-[219px] top-9">
        <Buildings />
      </div>
    </section>
  );
